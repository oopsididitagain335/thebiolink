...
// We're NOT using signIn from next-auth for Discord right now
...
export default function LoginPage() {
  ...
  const handleDiscordLogin = () => {
    // Temporarily disabled — show "Not ready yet" message
    setError('Discord login is not ready yet. Please use email/password for now.');
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-2xl p-8">
          ...
          {/* Discord Login Button - Temporarily Disabled */}
          <button
            type="button"
            onClick={handleDiscordLogin}
            className="w-full flex items-center justify-center gap-3 bg-indigo-900/50 text-gray-400 cursor-not-allowed py-3 rounded-xl font-medium"
            disabled
          >
